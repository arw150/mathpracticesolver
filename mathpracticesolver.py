...
Problem1_question = '∫½x²'
Problem1_First_Correct_Answer = '½'+'∫'+ str(stringify_exponent(x,2))
Problem1_First_Wrong_Answer = '∫'+ '½'+ str(stringify_exponent(x,2))
Problem1_Second_Wrong_Answer = '∫'+ '½' + str(stringify_exponent(x,3))
...
button_false2 = tkinter.Button(window,text= button4_text, command = wronganswer)
